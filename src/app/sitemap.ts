...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/yardim`, lastModified: now, changeFrequency: 'weekly', priority: 0.6 },
    ...
    { url: `${base}/yenilikler`, lastModified: now, changeFrequency: 'weekly', priority: 0.6 },
    { url: `${base}/enterprise`, lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${base}/beta`, lastModified: now, changeFrequency: 'monthly', priority: 0.5 },
    { url: `${base}/sektor-quiz`, lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${base}/sablon`, lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${base}/durum`, lastModified: now, changeFrequency: 'daily', priority: 0.5 },
    { url: `${base}/mobil-uygulama`, lastModified: now, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${base}/press-kit`, lastModified: now, changeFrequency: 'monthly', priority: 0.4 },
    { url: `${base}/vs/bilet`, lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${base}/vs/logo-tiger`, lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${base}/vs/calendly`, lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${base}/vs/shopify`, lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${base}/vs/parasut`, lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
