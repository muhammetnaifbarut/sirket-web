...
const PRODUCTS = [
  ...
  { slug: 'servis', name: 'kooza Servis', tagline: 'Saha servis ve teknik destek', description: 'Saha servis ekipleri, teknik destek hizmetleri, periyodik bakım sözleşmeleri.', icon: '🛠️', badge: 'CANLI', videoUrl: 'https://servis.kooza.tr', features: ['Saha ekibi yönetimi', 'Periyodik bakım takvimi', 'Sözleşme yenileme', 'SLA takibi', 'GPS rota optimizasyonu', 'Müşteri portalı', 'Stok + parça', 'Mobil teknisyen'], screenshots: [], order: 8 },
...
const SOLUTIONS = [
  ...
  {
    slug: 'servis', name: 'kooza Servis', icon: 'Settings', iconColor: '#0EA5E9', bgColor: '#f0f9ff',
    tagline: 'Saha servis ekipleri ve teknik destek için',
    heroBadge: 'Saha Servis', heroTitle: 'Saha ekibi, periyodik\nbakım — tek panel',
    heroSubtitle: 'Saha servis ekipleri, teknik destek ve periyodik bakım için: ekip yönetimi, bakım takvimi, sözleşme yenileme, SLA takibi, GPS rota, müşteri portalı, mobil teknisyen uygulaması.',
    problems: [
      { title: 'Periyodik bakım kaçırılıyor', description: 'Sözleşme tarihleri Excel\'de, hatırlatma yok, müşteri kayıyor.', icon: 'CalendarX' },
      { title: 'Saha ekibi nereye gitti bilinmiyor', description: 'GPS yok, rota optimizasyonu yok, gün boyu trafiğin içinde.', icon: 'MapPinOff' },
      { title: 'SLA ihlalleri ceza üretiyor', description: 'Müşteriye SLA verdin, takip edilmiyor, ceza ödüyorsun.', icon: 'TimerOff' },
    ],
    features: [
      { title: 'Saha ekibi yönetimi', description: 'Teknisyen atama, vardiya, GPS konumu, anlık iş atama.', icon: 'Users' },
      { title: 'Periyodik bakım takvimi', description: 'Sözleşme tarihleri, otomatik hatırlatma, planlama.', icon: 'CalendarCheck' },
      { title: 'SLA takibi', description: 'Müşteriye verilen süre takip edilir, otomatik uyarı, raporlama.', icon: 'Timer' },
      { title: 'GPS rota optimizasyon', description: 'Günlük çağrılar için en kısa rota, yakıt tasarrufu.', icon: 'Route' },
      { title: 'Müşteri portalı', description: 'Müşteri kendi taleplerini açar, durumu görür, geçmişi inceler.', icon: 'Globe' },
      { title: 'Stok + parça yönetimi', description: 'Teknisyen aracında stok takibi, ihtiyaç olduğunda anında sipariş.', icon: 'Package' },
    ],
    benefits: [
      { label: 'Periyodik bakım kayıp', value: '-%90', description: 'Otomatik hatırlatma' },
      { label: 'Saha verimi', value: '+%35', description: 'GPS rota optimizasyon' },
      { label: 'SLA uyumu', value: '%98+', description: 'Otomatik takip' },
      { label: 'Müşteri memnuniyet', value: '+%70', description: 'Şeffaf süreç' },
    ],
    modules: [
      { name: 'Saha Ekibi', description: 'Teknisyen, vardiya, GPS' },
      { name: 'Bakım Takvimi', description: 'Periyodik, planlama, hatırlatma' },
      { name: 'SLA Yönetimi', description: 'Süre, uyarı, raporlama' },
      { name: 'Rota Optimizasyon', description: 'GPS, mesafe, yakıt' },
      { name: 'Müşteri Portalı', description: 'Talep, durum, geçmiş' },
      { name: 'Stok Yönetimi', description: 'Araç + depo + sipariş' },
      { name: 'Sözleşme Yenileme', description: 'Otomatik bildirim' },
      { name: 'Mobil Teknisyen', description: 'PWA, fotoğraf, imza' },
    ],
    faqs: [
      { question: 'Hangi servis tipleri için uygun?', answer: 'Asansör bakımı, jeneratör servisi, kombi-petek bakımı, IT teknik destek, güvenlik kamera servisi, klima bakımı, makine bakım servisleri.' },
      { question: 'GPS rota nasıl çalışıyor?', answer: 'Günün çağrı listesi GPS koordinatları ile yüklenir, en kısa rota algoritması ile sıralanır. Trafik durumuna göre dinamik güncellenir.' },
      { question: 'SLA takibi nasıl?', answer: 'Müşteriye verdiğiniz cevap süresi (örn: 2 saat) sistemde tanımlanır. Süre dolmadan teknisyene + yöneticiye uyarı gider, raporlama yapılır.' },
      { question: 'Müşteri portalı dahil mi?', answer: 'Evet, müşteriniz kendi web hesabından talep açar, durumu takip eder, geçmiş işlemleri görür. Subdomain ve markalama özelleştirilir.' },
    ],
    ctaTitle: 'Saha servisinizi modernleştirin', ctaSubtitle: '14 gün ücretsiz, ilk müşteri sözleşmenizi içe aktarın.', order: 8,
  },
  {
